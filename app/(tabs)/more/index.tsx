...
const LINKS = [
  { screen: "barn", title: "العنبر", icon: Warehouse, description: "إدارة العنابر والمخازن", color: "#6366f1" },
  { screen: "customers", title: "العملاء", icon: Users, description: "إدارة العملاء والمبيعات", color: "#8b5cf6" },
  { screen: "suppliers", title: "الموردين", icon: Truck, description: "إدارة الموردين والمشتريات", color: "#ec4899" },
  { screen: "settings", title: "الإعدادات", icon: Settings, description: "إعدادات التطبيق والتنبيهات", color: "#64748b" },
] as const;
  ...
  return (
    ...
    >
      ...
      <View className="mt-12 items-center opacity-40">
        <AppText variant="caption">إصدار التطبيق 1.0.0</AppText>
      </View>
    </AppScreen>
  );
}
